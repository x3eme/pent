...
class CCIIndicator(IndicatorMixin):
    ...
    def ccilow(self) -> pd.Series:
        """Commodity Channel Index (CCI)

        Returns:
            pandas.Series: New feature generated.
        """
        cci_series = self._check_fillna(self._ccilow, value=0)
        return pd.Series(cci_series, name="cci")
    def ccihigh(self) -> pd.Series:
        """Commodity Channel Index (CCI)

        Returns:
            pandas.Series: New feature generated.
        """
        cci_series = self._check_fillna(self._ccihigh, value=0)
        return pd.Series(cci_series, name="cci")
