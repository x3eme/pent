...
class main:
    ...
    def run(self):
        ...
        try:
            ...
            self.symbol_records = ["AAVEUSDT", "BCHUSDT", "BNBUSDT", "DENTUSDT", "EOSUSDT", "ETCUSDT", "FTMUSDT", "ICXUSDT", "LITUSDT", "NKNUSDT", "OMGUSDT", "REEFUSDT", "RENUSDT", "ZRXUSDT", "FLMUSDT", "KSMUSDT", "LUNAUSDT"]
